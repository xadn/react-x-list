...
###*
  @param {string} str
  @param {number} size
  @return {Array.<Object>} object with propeties: text, index, total
###
este.string.chunkToObject = (str, size) ->
  chunked = este.string.chunk str, size
...
este.string.REMOVE_DIACRITICS_MAP =
