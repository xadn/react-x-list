...
class este.validators.Url extends este.validators.Base
  ...
  getMsg: ->
    ...
    ###
    Url.MSG_VALIDATOR_URL = goog.getMsg 'Please enter a valid URL.'

###*
  @param {function(): string=} getMsg
  @return {function(): este.validators.Url}
###
este.validators.url = (getMsg) ->
  -> new este.validators.Url getMsg